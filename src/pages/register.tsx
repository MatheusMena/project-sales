  ...
  return (
    <div className='flex items-center justify-center min-h-screen lg:px-20 text-center bg-slate-300'>
      <form
        ...
        className='bg-slate-100 lg:static absolute z-10 rounded-r-lg shadow-2xl flex flex-col items-center justify-center w-screen h-screen sm:w-1/2 sm:h-[50%] sm:py-10 lg:h-[80vh] lg:px-20 '
      >
